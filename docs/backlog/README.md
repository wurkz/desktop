...
| Phase 2 — Repair Module | [backlog](./phase-2-backlog.md) | [completed](./phase-2-completed.md) | ~95% (everything shipped; 5 open: **BACK-2-012** Jobs date filter, **BACK-2-013** photo-note keyboard UX, **BACK-2-014** print job order at estimate, **BACK-2-015** mechanic dashboard cleanup + backup API gating, **BACK-2-016** Start Job mechanic-only) |
