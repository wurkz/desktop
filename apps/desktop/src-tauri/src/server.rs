...
pub async fn start_server(app: AppHandle, pool: Pool<Sqlite>) {
    ...
    let router = Router::new()
        ...
        .route("/api/orders/:id/discounts", post(api_data::set_discounts))
        .route("/api/orders/:id/approve", post(api_data::approve_order))
        .route("/api/orders/:id/assign", post(api_data::assign_order))
        .route("/api/orders/:id/start", post(api_data::start_order))
        .route("/api/orders/:id/cancel", post(api_data::cancel_order))
        ...
        .route("/api/reports/financial-summary", get(financials::financial_summary))
        .route("/api/reports/senior-pwd", get(financials::senior_pwd_report))
        .route("/api/reports/mechanics", get(financials::mechanic_report))
        .route("/api/reports/receivables", get(financials::receivables))
